...
link:https://github.com/tillgr/swt19w24/tree/srs/src/main/asciidoc/srs[Pflichtenheft]
link:https://github.com/tillgr/swt19w24/tree/master/src/main/asciidoc/protocols[Protocols]
