...
|OrdersController, ReceivingController, OrderDataInitializer, ServiceDataInitializer, CatalogController, CatalogDataInitializer, InventoryInitializer
...
|PickUpController, ReceivingController, UserController, CatalogController, InventoryController, FinanceController
...
|org.salespointframework.inventory.InventoryItemIdentifier
|InventoryController
...
|orderItem, Material, CatalogDataInitializer, InventoryInitializer 

|Model 
|org.{zwsp}springframework.{zwsp}ui.{zwsp}Model 
|OrdersController, PickUpController, ReceivingController, UserController, CatalogController, InventoryController, FinanceController

|Money 
|org.{zwsp}javamoney.{zwsp}moneta.{zwsp}Money 
|OrderService, ServiceDataInitializer, CatalogDataInitializer
...
|PickUpController, ReceivingController, UserController, InventoryController
...
|MissMintOrder, InventoryInitializer, InventoryController
...
|FinanceManager, InventoryController, CatalogDataInitializer

|UniqueInventory
|org.salespointframework.inventory.UniqueInventory
|InventoryInitializer, InventoryController
...
=== Inventar
image::models/design/images/sd_consume_UniqiueInventoryItem.png[]
